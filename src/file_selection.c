...
void
get_file_name (GtkWidget * widget, GtkSplitterWindow * gsw)
{
  gchar *selected_file;
...
void
set_file_name (GtkSplitterWindow * gsw, gchar * file_name_to_set)
{
  gchar *pos;
...
get_directory_name_dialog (GtkWidget * widget, GtkSplitterWindow * gsw)
{
  /* Set up a simple gtk file selection dialog. */
  gsw->file_selection_dialog =
    gtk_file_selection_new ("Select the output directory.");
...
void
get_directory_name (GtkWidget * widget, GtkSplitterWindow * gsw)
{
...
void
set_directory_name (GtkSplitterWindow * gsw, gchar * directory_name_to_set)
{
