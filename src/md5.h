...
typedef enum 
{
   ...
   GENERATE_MD5_SYSTEM_ERROR, 
   GENERATE_MD5_SYSTEM_SH_NOT_AVAILABLE, 
   GENERATE_MD5_SYSTEM_SH_EXEC_ERROR,
...
typedef enum 
{
   ...
   VERIFY_FILE_SYSTEM_ERROR, 
   VERIFY_FILE_SYSTEM_SH_NOT_AVAILABLE,
   VERIFY_FILE_SYSTEM_SH_EXEC_ERROR,
