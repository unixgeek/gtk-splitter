/*
 * $Id: split.c,v 1.32 2005/04/18 04:37:29 techgunter Exp $
 *
...
gboolean
gtk_splitter_split_file2 (GtkSplitterSessionData * gssd)
{
  ...
  switch (gssd->unit)
    {
    case BYTES:
      chunk_size = gssd->entry;
      break;
    case KILOBYTES:
      chunk_size = (gssd->entry * 1024);
      break;
    case MEGABYTES:
      chunk_size = (gssd->entry * 1024 * 1024);
      break;
    default:
      chunk_size = gssd->entry;
      break;
